...
<html lang="en">
    ...
    <body> <!-- Start of body -->
        ...
        <div class="container"> <!-- Start of main body container -->
            <form class="form-inline" method="post"> <!-- Start of add user form -->
                    ...
                    if (isset($username) && !empty($username) && isset($password1) && !empty($password1) && isset($password2) && !empty($password2))
                    {
                        ...
                        if ($password1 == $password2)
                        {
                            ...
                            else
                            {
                              ...
                              # Displays success message - "Successfully added new user"
                              echo "<br><div class='alert alert-success'>Successfully added new user</div>";
                            }
                        }
                        # Else the passwords do not match
                        else
                        {
                            # Displays error message - "The passwords are not the same"
                            echo "<br><div class='alert alert-danger'>The passwords are not the same</div>";
                        }
                    }
