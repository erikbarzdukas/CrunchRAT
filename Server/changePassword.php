        ...
        <div class="container"> <!-- Start of main body container -->
            <form class="form-inline" method="post"> <!-- Start of form -->
                <div class="form-group">
                    ...
                    <input style="width: 180px;" type="password" class="form-control" name="newPassword2" placeholder="Confirm New Password">
                </div>
                        ...
                        if ($rowCount == 1)
                        {
                            ...
                            if ($newPassword1 == $newPassword2)
                            {
                                ...
                                else
                                {
                                    ...
                                    # Displays success message - "Successfully changed password"
                                    echo "<br><div class='alert alert-success'>Successfully changed password</div>";
                                }
                            }
                            # Else the new passwords are not the same (likely mistyped by the RAT user)
                            else
                            {
                                # Displays error message - "The new passwords are not the same"
                                echo "<br><div class='alert alert-danger'>The new passwords are not the same</div>";
                            }
                        }
