...
<body> <!-- Start of body -->
    ...
    <div class="container">
        <table id="hostsTable" class="table table-striped table-bordered" cellspacing="0" width="100%"> <!-- Start of hosts dataTable -->
            <thead>
                <tr>
                    <th style="text-align: center;">Hostname</th>
                    <th style="text-align: center;">Last Beacon (UTC)</th>
                    <th style="text-align: center;">Operating System</th>
                    <th style="text-align: center;">Architecture</th>
                    <th style="text-align: center;">Beacon Interval</th>
