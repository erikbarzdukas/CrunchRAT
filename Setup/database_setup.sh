...
statement="$statement CREATE TABLE hosts (hostname VARCHAR(100), date VARCHAR(100), os VARCHAR(200), architecture VARCHAR(3), pid VARCHAR(10), pfilename VARCHAR(260)); ";
