...
statement="$statement CREATE TABLE hosts (hostname VARCHAR(100), date VARCHAR(100), os VARCHAR(200), architecture VARCHAR(3), beaconinterval VARCHAR(50), pid VARCHAR(10), pfilename VARCHAR(260)); ";
...
statement="$statement CREATE TABLE output (id INT(16) AUTO_INCREMENT, user VARCHAR(50), hostname VARCHAR(100), action VARCHAR(20), secondary TEXT(65535), output TEXT(65535), status VARCHAR(1), PRIMARY KEY (id)); ";
